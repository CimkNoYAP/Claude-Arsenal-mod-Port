...
public interface ArsenalEntities {
    ...
    EntityType<BloodScytheEntity> BLOOD_SCYTHE = createEntity("blood_scythe",
        FabricEntityTypeBuilder.<BloodScytheEntity>create(SpawnGroup.MISC, BloodScytheEntity::new)
            .disableSaving()
            .dimensions(EntityDimensions.changing(5.0f, 0.2f))
            .build());

    EntityType<AnchorbladeEntity> ANCHORBLADE = createEntity("anchorblade",
        FabricEntityTypeBuilder.<AnchorbladeEntity>create(SpawnGroup.MISC, AnchorbladeEntity::new)
            .disableSaving()
    ...
    EntityType<WeaponRackEntity> WEAPON_RACK = createEntity("weapon_rack",
        FabricEntityTypeBuilder.<WeaponRackEntity>create(SpawnGroup.MISC, WeaponRackEntity::new)
    ...
    private static <T extends EntityType<? extends Entity>> T createEntity(String name, T entity) {
        ENTITIES.put(entity, Arsenal.id(name));
        return entity;
    }
